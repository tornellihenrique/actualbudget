...
// Either a fixed pixel width or a share of the space left over once the fixed
// columns are laid out — the two modes `Cell`/`Field` already support.
export type TransactionTableColumnWidth = number | 'flex';
